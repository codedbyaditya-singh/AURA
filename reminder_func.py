...
#     # Schedule it
#     threading.Timer(delay, trigger_reminder, args=[task]).start()
...
#             if delay > 0:
#                 threading.Timer(delay, trigger_reminder, args=[task]).start()
#                 future_schedules.append(entry)
#         except:
#             continue

#     # Save only future schedules back
#     save_schedules(future_schedules)
...
import dateparser
import logging
# import winsound  # For Windows beep sound, optional, else use TTS only
